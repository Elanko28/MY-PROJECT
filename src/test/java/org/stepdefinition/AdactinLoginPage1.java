...
fillTextBox(a.getEmailText(), "elanko123");}

@When("To send the valaid password")
public void to_send_the_valaid_password() {
    fillTextBox(a.getPasswordText(), "e9l6a0n0");
}
...
public void enter_first_name() {
    ...
    fillTextBox(a4.getFirstName(), "elanko");
}

@When("Enter last name")
public void enter_last_name() {
    a4=new AdactinBookHotelPojo4();
    fillTextBox(a4.getLastName(), "thangarajan");
...
public void enter_billing_address() {
	a4=new AdactinBookHotelPojo4();
    fillTextBox(a4.getAddress(), "balaji mansion,saidapet 600015");
}

@When("Enter credit card number")
public void enter_credit_card_number() {
	a4=new AdactinBookHotelPojo4();
    fillTextBox(a4.getCcNumber(), "6123456789083333");
}
